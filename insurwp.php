 ...
 * Description:       Шорткод [insurwp_calculator] — расчёт стоимости медицинской страховки для иностранцев в Болгарии и Шенгене. Тарифы хранятся в JSON и редактируются из админ-панели. Кнопка «Заказать» открывает страницу оформления с переданными параметрами расчёта.
 * Version:           1.0.0
